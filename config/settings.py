...
MERCADOLIBRE_DISCOVERY_QUEUE = os.getenv(
    "MERCADOLIBRE_DISCOVERY_QUEUE", "discovery_mercadolibre"
)
...
AMAZON_TOP100_DISCOVERY_MAX_PAGES = int(
    os.getenv("AMAZON_TOP100_DISCOVERY_MAX_PAGES", str(AMAZON_DISCOVERY_MAX_PAGES))
)
AMAZON_NEWEST_DISCOVERY_MAX_PAGES = int(
    os.getenv("AMAZON_NEWEST_DISCOVERY_MAX_PAGES", str(AMAZON_DISCOVERY_MAX_PAGES))
)
AMAZON_TRACKERS_DISCOVERY_MAX_PAGES = int(
    os.getenv("AMAZON_TRACKERS_DISCOVERY_MAX_PAGES", str(AMAZON_DISCOVERY_MAX_PAGES))
)
...
MERCADOLIBRE_DISCOVERY_PROFILE_DIR = os.getenv(
    "MERCADOLIBRE_DISCOVERY_PROFILE_DIR",
    str(BASE_DIR / ".mercadolibre-discovery-profile"),
)
MERCADOLIBRE_DISCOVERY_HEADLESS = os.getenv(
    "MERCADOLIBRE_DISCOVERY_HEADLESS", "true"
).lower() == "true"
MERCADOLIBRE_DISCOVERY_BROWSER_LAUNCH_TIMEOUT_SECONDS = int(
    os.getenv("MERCADOLIBRE_DISCOVERY_BROWSER_LAUNCH_TIMEOUT_SECONDS", "60")
)
if MERCADOLIBRE_DISCOVERY_BROWSER_LAUNCH_TIMEOUT_SECONDS <= 0:
    raise ImproperlyConfigured(
        "MERCADOLIBRE_DISCOVERY_BROWSER_LAUNCH_TIMEOUT_SECONDS debe ser mayor que cero."
    )
for name, value in (
    ("AMAZON_TOP100_DISCOVERY_MAX_PAGES", AMAZON_TOP100_DISCOVERY_MAX_PAGES),
    ("AMAZON_NEWEST_DISCOVERY_MAX_PAGES", AMAZON_NEWEST_DISCOVERY_MAX_PAGES),
    ("AMAZON_TRACKERS_DISCOVERY_MAX_PAGES", AMAZON_TRACKERS_DISCOVERY_MAX_PAGES),
):
    if not 1 <= value <= 100:
        raise ImproperlyConfigured(f"{name} debe estar entre 1 y 100.")
